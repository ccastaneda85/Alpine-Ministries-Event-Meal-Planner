...
public interface KitchenPrepListItemRepository extends JpaRepository<KitchenPrepListItem, Long> {
    ...
    List<KitchenPrepListItem> findByKitchenPrepListKitchenPrepListIdAndAutoGenerated(Long kitchenPrepListId, Boolean autoGenerated);

    void deleteByKitchenPrepListKitchenPrepListIdAndAutoGeneratedTrue(Long kitchenPrepListId);
}
