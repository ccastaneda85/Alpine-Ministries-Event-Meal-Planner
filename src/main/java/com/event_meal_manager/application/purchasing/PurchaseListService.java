...
public class PurchaseListService {
    ...
    public int clearGeneratedItems(Long purchaseListId) {
        return purchaseListGenerationService.clearGeneratedItems(purchaseListId);
    }
    ...
    @Transactional
    public PurchaseListItem addItem(Long purchaseListId, String itemName, float quantity, String uom, String notes, Long ingredientId) {
